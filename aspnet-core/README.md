...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p df8b54c1-f974-400b-a710-f38946bd0711
```

> `df8b54c1-f974-400b-a710-f38946bd0711` is the password of the certificate, you can change it to any password you want.
